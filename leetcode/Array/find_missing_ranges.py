...
A Math x is considered missing if x is in the range [lower, upper] and x is not in nums.

Return the smallest sorted list of ranges that cover every missing Math exactly.
That is, no element of nums is in any of the ranges, and each missing Math is in one of the ranges.
